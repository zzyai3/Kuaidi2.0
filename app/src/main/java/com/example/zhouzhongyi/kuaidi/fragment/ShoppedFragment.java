...
public class ShoppedFragment extends Fragment {
    ...
    @Bind(R.id.recycler_view_shopped)
    RecyclerView mRecyclerView;

    private int type = TYPE_LINEAR_LAYOUT;

    public static ShoppedFragment newInstance(int type) {
        ShoppedFragment fragment = new ShoppedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_shopped, container, false);
