...
import com.example.zhouzhongyi.kuaidi.adapter.OrderingAdapter;
 ...
 */
public class Main_rb_2Fragment extends android.support.v4.app.Fragment {
   ...
   // @Bind(R.id.recycler_view)
    ...
    public static Main_rb_2Fragment newInstance(int type) {
        Main_rb_2Fragment fragment = new Main_rb_2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_main_rb_2, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(new OrderingAdapter(getActivity()));
