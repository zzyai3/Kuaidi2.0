...
import com.example.zhouzhongyi.kuaidi.adapter.ReAdapter;
 ...
 */
public class Main_centerFragment extends android.support.v4.app.Fragment {
    ...
    public static Main_centerFragment newInstance(int type) {
        Main_centerFragment fragment = new Main_centerFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(new ReAdapter(getActivity()));
